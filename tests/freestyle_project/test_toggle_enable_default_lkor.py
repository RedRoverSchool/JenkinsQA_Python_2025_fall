...
def test_TC_02_001_002_toggle_enable(page):
    ...
    toggle_input_loc = "input#enable-disable-project"

    # Preconditions: создать Freestyle проект
    ...
    expect(page.locator(toggle_input_loc)).to_be_visible()

    expect(page.locator(toggle_input_loc)).to_be_checked()
